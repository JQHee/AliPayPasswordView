...
#import "JQPayPasswordErrorView.h"
...
@interface JQPayPasswordView()<UITextFieldDelegate>
...
@property (nonatomic, strong) JQPayPasswordErrorView *errorView;

@end

@implementation JQPayPasswordView
...
- (void)showPasswordErrorWithLimit:(NSInteger )limit{
    [self stopLoading];
    self.errorView = [[JQPayPasswordErrorView alloc] init];
...
- (UITextField *)passwordField{
    if (_passwordField == nil){
        _passwordField = [[JQPayPasswordTextField alloc] init];
